...
The concept of different routing patterns doesn’t make sense because in this case there is a direct link between sender and receiver
...
*TODO:* Update to reflect new structure ..
