...
AMQ_INTERCONNECT_ROUTE_URL=DNS:amq-mesh-inter-router-broker-with-interconnect-mesh.apps.y3tpfd3p.westeurope.aroapp.io,DNS:amq-edge-console-broker-with-interconnect-mesh.apps.y3tpfd3p.westeurope.aroapp.io,DNS:amq-mesh-console-broker-with-interconnect-mesh.apps.y3tpfd3p.westeurope.aroapp.io
