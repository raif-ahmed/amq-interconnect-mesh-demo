AMQ_BROKER_ROUTE_URL=dns:mesh-broker-amqps-0-svc-rte-broker-with-interconnect-mesh.apps.y3tpfd3p.westeurope.aroapp.io,dns:edge-broker-amqps-0-svc-rte-broker-with-interconnect-mesh.apps.y3tpfd3p.westeurope.aroapp.io
